...
public class Door_Lock_Unlock extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            {
               txt_door_status.setText("Currently the door is "+dataSnapshot.child("lock_value").getValue());
            }
        ...
        btn_lock.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
                ...
                if (ni == null) {
                    ...
                    ref.child("lock_value").setValue("lock");
                    //sendOnChannel2(v);
                }
            }
        });
        ...
        btn_unlock.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
                ...
                if (ni == null) {
                    ...
                    ref.child("lock_value").setValue("unlock");
                    //sendOnChannel1(v);
                }
